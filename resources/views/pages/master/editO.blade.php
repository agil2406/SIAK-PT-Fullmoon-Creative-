...
@section('title')
Edit Data Master Buku Operasional
@endsection
...
<div class="card">
    <div class="card-body">
        ...
        <div class="container">
            <form action="{{url('masterO').'/'.$master->id}}" method="POST">
                @method('put')
                @csrf
                ...
                <div class=" modal-footer">
                    ...
                    <a href="{{url('dmbukuoperasional')}}" class="btn btn-secondary" type="reset">Kembali</a>
                </div>
            </form>
