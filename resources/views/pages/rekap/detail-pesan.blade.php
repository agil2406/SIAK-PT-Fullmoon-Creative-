    ...
    <div class="card-body">
        ...
        <form action="{{url('pesan/save')}}" method="POST">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control @error('pesan') is-invalid  @enderror" placeholder="Pesan" id="floatingTextarea" style="height: 100px;" name="pesan" readonly>{{$data->pesan}}</textarea>
                    @error('pesan')
            ...
            <div class="text-center mt-3">
                <a href="{{url('/pengajuan')}}" class="btn btn-secondary" type="reset">Batal</a>
            </div>
